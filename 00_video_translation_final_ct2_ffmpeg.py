...
def load_nllb200_translator_ct2(model_dir: str = "nllb-200-1.3B-int8_bfloat16",
...
def translate_segments_optimized_safe(
    ...
    with gpu_context():
        ...
        # --- OPTION 1: MADLAD400 (CTranslate2, schnell, empfohlen) ---
        logger.info("Verwende MADLAD400 CTranslate2 für die Übersetzung.")
        ...
        for i in tqdm(range(0, len(segments_to_process), batch_size), desc="Übersetze geschützte Batches"):
            ...
            # Aufruf der MADLAD-Übersetzungsfunktion (Batch-Übersetzung mit CTranslate2)
        ...
        # --- OPTION 2: NLLB-200 (CTranslate2, schnell, auskommentiert) ---
